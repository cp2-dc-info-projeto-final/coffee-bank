        ...
        <div class="p-6 rounded-3xl bg-white space-y-4 md:space-y-6 sm:p-8">
          ...
          <script>
           ...
           <form class="space-y-4 md:space-y-6" method="POST" id="form">
            ...
            <!-- Campo Senha 5 -->
            <div>
              <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Sua Senha 5</label>
            ...
            <div>
              <a href="#" class="text-sm font-medium hover:underline text-blue-500">Esqueceu sua senha?</a>
            </div>
            ...
            <p class="text-sm font-light text-gray-400">
              Sem uma conta ainda?
              <a href="/Cadastro" class="font-medium text-blue-600 hover:underline">Crie uma aqui!</a>
            </p>
          </form>
        </div>
      </div>
