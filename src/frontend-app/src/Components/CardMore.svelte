...
<button on:click={()=>{modal=!modal}} class="w-full md:w-70">
    ...
    class="border md:border-0 md:rounded-lg border-gray-200 w-full md:w-70 bg-white md:bg-transparent flex flex-col shadow-lg justify-center items-center opacity-90">
