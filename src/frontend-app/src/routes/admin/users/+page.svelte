    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center space-x-6">
        ...
        <div>
          ...
          <p class="text-blue-100 text-lg">Visualize e gerencie todos os usuários do sistema</p>
        </div>
      </div>
    ...
    <div class="p-8">
      <div class="flex flex-col sm:flex-row gap-4">
        ...
        <button
          ...
          class="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
        >
    ...
    {#if isLoading}
      <div class="flex items-center justify-center py-20">
        <div class="text-center">
          ...
          <p class="text-blue-600 font-medium text-lg">Carregando usuários...</p>
        </div>
      </div>
