...
<div class="space-y-6">
  ...
  <div class="flex justify-between items-center">
    ...
    <div class=" text-orange-600 text-x font-bold bg-gradient-to-r from-orange-700 via-orange-800 to-orange-500 bg-clip-text text-transparent text-5xl font-black">
