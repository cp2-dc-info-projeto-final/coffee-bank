  ...
  <div class="bg-gradient-to-r from-[#1f5f61] to-[#36544f] rounded-2xl p-8 text-white shadow-xl">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-[#0b8185] text-lg">Visão geral do sistema Coffee Bank</p>
      </div>
  ...
  {#if isLoading}
    <div class="flex items-center justify-center py-20">
      <div class="text-center">
        ...
        <p class="text-[#0b8185] font-medium text-lg">Carregando dados...</p>
      </div>
    </div>
  {:else if error}
  ...
  {:else}
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
        ...
        <div class="bg-gradient-to-r from-[#30261c]/10 to-[#403831]/10 px-6 py-4">
          <div class="flex items-center">
