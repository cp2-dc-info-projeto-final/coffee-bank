  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 md:py-16">
    <div class="grid md:grid-cols-2 gap-10 items-center">
      <div class="animate-fade-in-up">
        ...
        <a href="/" class="mt-6 inline-flex items-center justify-center px-6 py-3 rounded-xl text-white bg-gradient-to-r from-amber-600 to-amber-800 hover:from-amber-700 hover:to-amber-900 transition-all duration-300 shadow hover:shadow-lg">Voltar a página inicial</a>
        <a href="/Cadastro" class="mt-6 inline-flex items-center justify-center px-6 py-3 rounded-xl text-white bg-gradient-to-r from-amber-600 to-amber-800 hover:from-amber-700 hover:to-amber-900 transition-all duration-300 shadow hover:shadow-lg">Cadastrar-se</a>
      </div>
